...
MATERIAL_LIBRARY = {
    "TEMPERATE": {
        "structure": {
            "primary_wall": {"variants": ["stone_bricks", "cobblestone", "andesite"], "weights": [0.6, 0.3, 0.1]},
            "foundation": "cobblestone",
            "accent": ["stripped_oak_log", "oak_log"],
            "roof": {"block": "dark_oak_planks", "stairs": "dark_oak_stairs", "slab": "dark_oak_slab"},
            "decor": {
    ...
    "LUSH": {  # Jungle / Swamp / Mangrove
        "structure": {
            ...
            "roof": {"block": "jungle_planks", "stairs": "jungle_stairs", "slab": "jungle_slab"},
            "decor": {
    ...
    "AQUATIC": {  # Ocean / River / Deep Sea
        "structure": {
            ...
            "accent": ["stripped_oak_log", "oak_log"],
            "roof": {"block": "dark_prismarine", "stairs": "dark_prismarine_stairs", "slab": "dark_prismarine_slab"},
            "decor": {
    ...
    "BADLANDS": {
        "structure": {
            ...
            "accent": ["dark_oak_log", "stripped_dark_oak_log"],
            "roof": {"block": "dark_oak_planks", "stairs": "dark_oak_stairs", "slab": "dark_oak_slab"},
            "decor": {
